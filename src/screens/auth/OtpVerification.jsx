...
export default function OtpVerification() {
    ...
    const role = location.state?.role || "Consignee";
        ...
        <main className="p-4 sm:p-6 lg:p-8 max-w-md w-full mx-auto flex items-center justify-center min-h-screen bg-gray-50">
            <Card className="w-full">
                ...
                <Button
                    ...
                    onClick={() => {
                        if (role === "Truck Owner") {
                            navigate("/tempo-owner/dashboard"); // 🚛 Tempo Owner Dashboard
                        } else if (role === "Consignee") {
                            navigate("/consignee/dashboard"); // 📦 Consignee Dashboard
                        } else if (role === "Corporate Client") {
                            navigate("/corporate-client/dashboard"); // 📦 Consignee Dashboard
                        }  else {
                            navigate("/"); // fallback or default
                        }
                    }}
                >
                    Verify & Continue
                ...
                <div className="flex justify-center">
                    <button className="flex items-center gap-2 text-sm text-gray-600 hover:text-[#211C84]"
